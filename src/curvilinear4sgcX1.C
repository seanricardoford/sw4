...
//         for (int i = ifirst + 2; i <= ilast - 2; i++) {
    ...
    RAJA::kernel<
      ...
      //             (mu(i - 2, j, k) * met(3, i - 2, j, k) * met(1, i - 2, j,
      //             k) *
      //                  dudrm2 +
      //              mu(i - 2, j, k) * met(2, i - 2, j, k) * met(1, i - 2, j,
      //              k) *
      ...
      //             (mu(i - 1, j, k) * met(3, i - 1, j, k) * met(1, i - 1, j,
      //             k) *
      //                  dudrm1 +
      //              mu(i - 1, j, k) * met(2, i - 1, j, k) * met(1, i - 1, j,
      //              k) *
      ...
      //           *
      //                dudrm2 +
      //            (2 * mu(i, j - 2, k) + la(i, j - 2, k)) * met(3, i, j - 2,
      //            k) *
      ...
      //           *
      //                dudrm1 +
      //            (2 * mu(i, j - 1, k) + la(i, j - 1, k)) * met(3, i, j - 1,
      //            k) *
      ...
      // // 39 ops, tot=4845
      // if (N==3)
      // r3 += (c2 * (mu(i, j + 2, k) * met(3, i, j + 2, k) * met(1, i, j + 2,
      // k) *
      //                  dwdrp2 * stry(j + 2) +
      //              mu(i, j + 2, k) * met(4, i, j + 2, k) * met(1, i, j + 2,
      //              k) *
      //                  dvdrp2 -
      ...
      //        c1 * (mu(i, j + 1, k) * met(3, i, j + 1, k) * met(1, i, j + 1,
      //        k) *
      //                  dwdrp1 * stry(j + 1) +
      //              mu(i, j + 1, k) * met(4, i, j + 1, k) * met(1, i, j + 1,
      //              k) *
      //                  dvdrp1 -
